...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers("/css/**").antMatchers("/scripts/**").antMatchers("/images/**")
				...
				.antMatchers("/").antMatchers("/Bug/bugprioritylist").antMatchers("/Bug/bugclasslist")
				.antMatchers("/Product/namelist");
	}
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/Bug/bugprioritylist").permitAll();
		http.authorizeRequests().antMatchers("/Bug/bugclasslist").permitAll();
		http.authorizeRequests().antMatchers("/Product/namelist").permitAll();
		// define login pages
		http.csrf().disable();
